...
#ifndef ADOG_LEGGED_HARDWARE_INTERFACE__VISIBILITY_CONTROL_H_
#define ADOG_LEGGED_HARDWARE_INTERFACE__VISIBILITY_CONTROL_H_
...
#endif  // ADOG_LEGGED_HARDWARE_INTERFACE__VISIBILITY_CONTROL_H_
