...
public:
  ...
  // Open a device
  char openDevice(
    const char * Device, const unsigned int Bauds, SerialDataBits Databits = SERIAL_DATABITS_8,
  ...
  int readString(
    char * receivedString, char finalChar, unsigned int maxNbBytes,
  ...
  int readBytes(
    void * buffer, unsigned int maxNbBytes, const unsigned int timeOut_ms = 0,
