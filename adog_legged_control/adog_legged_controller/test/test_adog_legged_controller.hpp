...
#ifndef TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_ADOG_LEGGED_CONTROLLER_HPP_
#define TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_ADOG_LEGGED_CONTROLLER_HPP_
...
using ControllerStateMsg = adog_legged_controller::AdogLeggedController::ControllerStateMsg;
using ControllerReferenceMsg = adog_legged_controller::AdogLeggedController::ControllerReferenceMsg;
using ControllerModeSrvType = adog_legged_controller::AdogLeggedController::ControllerModeSrvType;
...
class TestableAdogLeggedController : public adog_legged_controller::AdogLeggedController
{
  FRIEND_TEST(AdogLeggedControllerTest, all_parameters_set_configure_success);
  FRIEND_TEST(AdogLeggedControllerTest, activate_success);
  FRIEND_TEST(AdogLeggedControllerTest, reactivate_success);
  FRIEND_TEST(AdogLeggedControllerTest, test_setting_slow_mode_service);
  FRIEND_TEST(AdogLeggedControllerTest, test_update_logic_fast);
  FRIEND_TEST(AdogLeggedControllerTest, test_update_logic_slow);

public:
  controller_interface::CallbackReturn on_configure(
    const rclcpp_lifecycle::State & previous_state) override
  {
    auto ret = adog_legged_controller::AdogLeggedController::on_configure(previous_state);
...
class AdogLeggedControllerFixture : public ::testing::Test
{
public:
  ...
  void SetUp()
  {
    ...
    command_publisher_ = command_publisher_node_->create_publisher<ControllerReferenceMsg>(
      "/test_adog_legged_controller/commands", rclcpp::SystemDefaultsQoS());
    ...
    slow_control_service_client_ = service_caller_node_->create_client<ControllerModeSrvType>(
      "/test_adog_legged_controller/set_slow_control_mode");
  }
...
protected:
  void SetUpController(const std::string controller_name = "test_adog_legged_controller")
  {
  ...
  void subscribe_and_get_messages(ControllerStateMsg & msg)
  {
    ...
    auto subscription = test_subscription_node.create_subscription<ControllerStateMsg>(
      "/test_adog_legged_controller/state", 10, subs_callback);
...
protected:
  ...
  std::unique_ptr<TestableAdogLeggedController> controller_;
...
#endif  // TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_ADOG_LEGGED_CONTROLLER_HPP_
