...
#include "test_adog_legged_controller.hpp"
...
using adog_legged_controller::CMD_MY_ITFS;
using adog_legged_controller::control_mode_type;
using adog_legged_controller::STATE_MY_ITFS;

class AdogLeggedControllerTest : public AdogLeggedControllerFixture<TestableAdogLeggedController>
{
};

TEST_F(AdogLeggedControllerTest, all_parameters_set_configure_success)
{
  SetUpController();
...
TEST_F(AdogLeggedControllerTest, check_exported_intefaces)
{
  SetUpController();
...
TEST_F(AdogLeggedControllerTest, activate_success)
{
  SetUpController();
...
TEST_F(AdogLeggedControllerTest, update_success)
{
  SetUpController();
...
TEST_F(AdogLeggedControllerTest, deactivate_success)
{
  SetUpController();
...
TEST_F(AdogLeggedControllerTest, reactivate_success)
{
  SetUpController();
...
TEST_F(AdogLeggedControllerTest, test_setting_slow_mode_service)
{
  SetUpController();
...
TEST_F(AdogLeggedControllerTest, test_update_logic_fast)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(AdogLeggedControllerTest, test_update_logic_slow)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(AdogLeggedControllerTest, publish_status_success)
{
  SetUpController();
...
TEST_F(AdogLeggedControllerTest, receive_message_and_publish_updated_status)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
